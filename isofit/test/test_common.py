...
def test_svd_inv_sqrt():
    ...
    assert np.allclose(result_matrix_3, scipy.linalg.inv(sample_array_3))
    assert np.allclose(result_matrix_sq_3 @ result_matrix_sq_3.T, result_matrix_3)

    # PD
    sample_array_4 = np.array([[2, -1, 0], [-1, 2, -1], [0, -1, 2]])
    result_matrix_4, result_matrix_sq_4 = svd_inv_sqrt(sample_array_4)
    assert np.allclose(result_matrix_4, scipy.linalg.inv(sample_array_4))
    assert np.allclose(result_matrix_sq_4 @ result_matrix_sq_4.T, result_matrix_4)
